...
namespace MarketPlaceMVC.Controllers
{
    ...
    {
        private MarketPlaceDatabaseEntities1 db = new MarketPlaceDatabaseEntities1();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "userID,username,firstname,lastname,email,password,credential_ID")] tblUser tblUser)
        {
            if (ModelState.IsValid)
            {
